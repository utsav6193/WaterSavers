...
- (void)viewDidLoad {
    ...
    pickerData = [NSArray arrayWithObjects:@"1", @"2", @"3", @"4", @"5", nil];
...
-(IBAction)btnNext:(id)sender
{
    ...
    [appDel.dictResults setObject:title forKey:@"shower_frequency"];
    Question5ViewController *viewController = [[Question5ViewController alloc] initWithNibName:@"Question5ViewController" bundle:nil];
