...
- (void)btnRightMenuClicked:(id)sender {
    [CommonMethods displayAlertwithTitle:AppName withMessage:@"Check the STAR certification mark on the dishwasher." withViewController:self];
}

-(IBAction)btnNext:(id)sender
{
    int row = (int)[picker selectedRowInComponent:0];
    [appDel.dictResults setObject:[NSNumber numberWithInt:row] forKey:@"dishwasher_type"];
    Question10ViewController *viewController = [[Question10ViewController alloc] initWithNibName:@"Question10ViewController" bundle:nil];
